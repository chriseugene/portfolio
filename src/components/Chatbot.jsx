...
const REPLIES = {
  ...
  about:      `**Chris Eugene** is an M.S. Electrical & Computer Engineering graduate from Saint Louis University (GPA 3.90, graduated May 2026).\n\nHe specializes in **power systems**, **embedded hardware**, and **nanoscale device fabrication**, with hands-on experience across circuits, power electronics, optical wireless communication, and university instruction.\n\nHe holds a B.S. in Electrical & Electronics Engineering from St. Joseph's College of Engineering, Chennai (GPA 3.67).`,
